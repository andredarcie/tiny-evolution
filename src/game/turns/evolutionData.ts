...
export const EVOLUTION_PATH: EvolutionDefinition[] = [
  ...
  { id: 'musgo', name: 'Musgo', emoji: '🌾', allowedBiomes: ['coast', 'land'], worldStage: 2, era: '🌿 Ordoviciano · ~450 Ma', description: 'As primeiras plantas a conquistar a terra firme, sem raízes verdadeiras nem vasos condutores. Os musgos absorvem água diretamente pela superfície e dependem dela para a reprodução. Turfa de musgo (Sphagnum) cobre 3% da superfície terrestre e armazena mais carbono do que todas as florestas tropicais juntas.', next: [
    { to: 'planta_vascular', biome: 'land', minPopulation: 1 },
  ] },
  { id: 'medusa', name: 'Medusa', emoji: '🪼', allowedBiomes: ['ocean', 'coast'], worldStage: 1, era: '💥 Cambriano · ~505 Ma', description: 'Predadoras primitivas com 95% do corpo composto de água. As águas-vivas não possuem coração, pulmões, cérebro nem sangue — apenas uma rede nervosa difusa. São os animais com maior eficiência calórica do oceano e algumas espécies são biologicamente imortais, revertendo ao estágio larval quando estressadas.', next: [] },
  { id: 'anemona_do_mar', name: 'Anêmona-do-mar', emoji: '🌺', allowedBiomes: ['ocean', 'coast'], worldStage: 1, era: '💥 Cambriano · ~540 Ma', description: 'Cnidários solitários que parecem flores mas são predadores com tentáculos urticantes. Possuem uma relação simbiótica famosa com o peixe-palhaço, que é imune ao veneno. Algumas anêmonas vivem por mais de 100 anos e são parentes próximas dos corais construtores de recifes.', next: [] },
  { id: 'coral', name: 'Coral', emoji: '🪸', allowedBiomes: ['ocean', 'coast'], worldStage: 1, era: '🪸 Ordoviciano · ~480 Ma', description: 'Animais coloniais que constroem as maiores estruturas biológicas do planeta. Os recifes de coral cobrem apenas 0,1% do oceano mas abrigam 25% de todas as espécies marinhas. Cada pólipo secretar carbonato de cálcio, e colônias centenárias constroem estruturas visíveis do espaço.', next: [] },
  { id: 'trilobita', name: 'Trilobita', emoji: '🦐', allowedBiomes: ['ocean', 'coast'], worldStage: 1, era: '💥 Cambriano · ~521 Ma', description: 'Os artrópodes dominantes por 270 milhões de anos. As trilobitas foram os primeiros animais com olhos compostos sofisticados, capazes de ver em quase 360°. Com mais de 20.000 espécies descritas e uma exoesqueleto mineralizado, formam um dos registros fósseis mais completos e estudados da paleontologia.', next: [] },
  ...
  { id: 'anelideo', name: 'Anelídeo', emoji: '🪱', allowedBiomes: ['ocean', 'coast', 'land'], worldStage: 1, era: '💥 Cambriano · ~530 Ma', description: 'Vermes segmentados com sistema circulatório fechado e neurônios agrupados em gânglios. Os anelídeos foram ancestrais dos artrópodes e demonstram que a segmentação corporal é uma estratégia evolutiva poderosa. As minhocas processam toneladas de solo por hectare por ano, sendo fundamentais para a fertilidade agrícola.', next: [
    { to: 'crustaceo', biome: 'coast', minPopulation: 1 },
    { to: 'inseto', biome: 'land', minPopulation: 1 },
  ] },
  { id: 'nematodeo', name: 'Nematódeo', emoji: '🪱', allowedBiomes: ['ocean', 'coast', 'land'], worldStage: 1, era: '💥 Cambriano · ~530 Ma', description: 'Os animais mais numerosos da Terra: estimam-se 57 bilhões de nematódeos por cada ser humano. Ocupam todos os ambientes, do fundo do oceano a solos árticos, e são essenciais na decomposição e reciclagem de nutrientes. Caenorhabditis elegans, um nematódeo de 1 mm, foi o primeiro animal multicelular a ter seu genoma completamente sequenciado.', next: [
    { to: 'inseto', biome: 'land', minPopulation: 1 },
    { to: 'aracnideo', biome: 'land', minPopulation: 1 },
  ] },
  { id: 'cordado_ancestral', name: 'Cordado Ancestral', emoji: '🪱', allowedBiomes: ['ocean'], worldStage: 1, era: '💥 Cambriano · ~530 Ma', description: 'Os primeiros animais com notocorda — um eixo de suporte flexível que, em nossos descendentes, evoluiu para a coluna vertebral. Pikaia, um cordado do Cambriano, é o parente mais antigo conhecido de todos os vertebrados. Nessa linhagem está o blueprint anatômico do ser humano.', next: [
    { to: 'vertebrado_basal', biome: 'ocean', minPopulation: 1 },
  ] },
  { id: 'vertebrado_basal', name: 'Vertebrado Basal', emoji: '🐟', allowedBiomes: ['ocean'], worldStage: 1, era: '🐟 Ordoviciano · ~480 Ma', description: 'Os primeiros animais com crânio e rudimentos de vértebras, mas ainda sem mandíbulas. Representados pelos conodontos e ostracodermos, esses peixes primitivos dependiam de filtração ou sucção para se alimentar. A evolução da mandíbula, derivada dos arcos branquiais, abriu um leque enorme de possibilidades alimentares.', next: [
    { to: 'peixe', biome: 'ocean', minPopulation: 1 },
  ] },
  { id: 'molusco', name: 'Molusco', emoji: '🐚', allowedBiomes: ['ocean', 'coast'], worldStage: 1, era: '💥 Cambriano · ~530 Ma', description: 'O segundo maior filo animal em número de espécies descritas, com mais de 85.000. De lesmas a polvos, os moluscos demonstram a plasticidade evolutiva de um plano corporal simples. O nautilo é considerado um fóssil vivo — praticamente idêntico a seus antepassados de 500 Ma.', next: [
    { to: 'cefalopode', biome: 'ocean', minPopulation: 1 },
  ] },
  { id: 'crustaceo', name: 'Crustáceo', emoji: '🦀', allowedBiomes: ['ocean', 'coast'], worldStage: 1, era: '🦀 Ordoviciano · ~490 Ma', description: 'Artrópodes com exoesqueleto rígido de quitina e carbonato de cálcio. Crustáceos colonizaram mares, água doce e terra firme com enorme sucesso. O krill antártico, em biomassa, é um dos organismos mais abundantes da Terra, sustentando baleias, pinguins e focas na base da cadeia alimentar polar.', next: [] },
  { id: 'inseto', name: 'Inseto', emoji: '🐛', allowedBiomes: ['land', 'coast'], worldStage: 2, era: '🌿 Devoniano · ~385 Ma', description: 'Com mais de 1 milhão de espécies descritas, os insetos são o grupo animal mais diverso da Terra — e possivelmente 80% de todas as espécies animais. Foram os primeiros animais a voar (Carbonífero, ~325 Ma) e desenvolveram metamorfose completa para explorar nichos distintos em fases diferentes da vida.', next: [] },
  { id: 'peixe', name: 'Peixe Ósseo Ancestral', emoji: '🐟', allowedBiomes: ['ocean', 'coast'], worldStage: 1, era: '🐟 Devoniano · ~420 Ma', description: 'Os peixes ósseos (Osteichthyes) são o grupo de vertebrados mais diverso, com mais de 30.000 espécies. A bexiga natatória, usada para controlar flutuabilidade, é homóloga aos pulmões dos tetrápodes — evidência de que a transição da água para a terra começou nos peixes que respiravam ar.', next: [
